...
class IntersectionArray(_object):
    ...
    __repr__ = _swig_repr
    def __init__(self, *args): 
        this = _pixy.new_IntersectionArray(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _pixy.delete_IntersectionArray
    __del__ = lambda self : None;
    def __getitem__(self, *args): return _pixy.IntersectionArray___getitem__(self, *args)
    def __setitem__(self, *args): return _pixy.IntersectionArray___setitem__(self, *args)
    def cast(self): return _pixy.IntersectionArray_cast(self)
    __swig_getmethods__["frompointer"] = lambda x: _pixy.IntersectionArray_frompointer
    if _newclass:frompointer = staticmethod(_pixy.IntersectionArray_frompointer)
IntersectionArray_swigregister = _pixy.IntersectionArray_swigregister
IntersectionArray_swigregister(IntersectionArray)

def IntersectionArray_frompointer(*args):
  return _pixy.IntersectionArray_frompointer(*args)
...
class Intersection(_object):
    ...
    if _newclass:m_x = _swig_property(_pixy.Intersection_m_x_get, _pixy.Intersection_m_x_set)
    __swig_setmethods__["m_y"] = _pixy.Intersection_m_y_set
    __swig_getmethods__["m_y"] = _pixy.Intersection_m_y_get
    if _newclass:m_y = _swig_property(_pixy.Intersection_m_y_get, _pixy.Intersection_m_y_set)
    __swig_setmethods__["m_n"] = _pixy.Intersection_m_n_set
    __swig_getmethods__["m_n"] = _pixy.Intersection_m_n_get
    if _newclass:m_n = _swig_property(_pixy.Intersection_m_n_get, _pixy.Intersection_m_n_set)
    ...
    if _newclass:m_reserved = _swig_property(_pixy.Intersection_m_reserved_get, _pixy.Intersection_m_reserved_set)
    ...
    if _newclass:m_intLines = _swig_property(_pixy.Intersection_m_intLines_get, _pixy.Intersection_m_intLines_set)
    def getLineIndex(self, *args): return _pixy.Intersection_getLineIndex(self, *args)
    def getLineAngle(self, *args): return _pixy.Intersection_getLineAngle(self, *args)
    def __init__(self): 
...
class Barcode(_object):
    ...
    if _newclass:m_x = _swig_property(_pixy.Barcode_m_x_get, _pixy.Barcode_m_x_set)
    __swig_setmethods__["m_y"] = _pixy.Barcode_m_y_set
    __swig_getmethods__["m_y"] = _pixy.Barcode_m_y_get
    if _newclass:m_y = _swig_property(_pixy.Barcode_m_y_get, _pixy.Barcode_m_y_set)
    __swig_setmethods__["m_flags"] = _pixy.Barcode_m_flags_set
    __swig_getmethods__["m_flags"] = _pixy.Barcode_m_flags_get
    if _newclass:m_flags = _swig_property(_pixy.Barcode_m_flags_get, _pixy.Barcode_m_flags_set)
    __swig_setmethods__["m_code"] = _pixy.Barcode_m_code_set
    __swig_getmethods__["m_code"] = _pixy.Barcode_m_code_get
    if _newclass:m_code = _swig_property(_pixy.Barcode_m_code_get, _pixy.Barcode_m_code_set)
    def __init__(self): 
